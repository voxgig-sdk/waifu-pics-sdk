...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/waifu-pics` | `npm install @voxgig-sdk/waifu-pics` |
| Python | `voxgig-sdk-waifu-pics` | `pip install voxgig-sdk-waifu-pics` |
| PHP | `voxgig-sdk/waifu-pics` | `composer require voxgig-sdk/waifu-pics` |
| Golang | `github.com/voxgig-sdk/waifu-pics-sdk/go` | `go get github.com/voxgig-sdk/waifu-pics-sdk/go` |
| Ruby | `voxgig-sdk-waifu-pics` | `gem install voxgig-sdk-waifu-pics` |
| Lua | `voxgig-sdk-waifu-pics` | `luarocks install voxgig-sdk-waifu-pics` |
