...
Results: Successful response with multiple image URLs.
...
| --- | --- | --- | --- |
| Image | `load` | `GET /many/{type}/{category}` | See reference |

## Connect to the API

- Production server: `https://api.waifu.pics`
...
- `waifu-pics_list`: List records for an entity. No active entity supports this operation.
- `waifu-pics_load`: Load one record for an entity. Supported entities: `image`.
