...
func registerSDKWords(r *eng.Registry, client *sdk.WaifuPicsSDK) {
...
func runOp(client *sdk.WaifuPicsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
