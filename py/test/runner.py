...
class WaifuPicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaifuPicsTestRunner.getenv("WAIFUPICS_TEST_LIVE")
        override = WaifuPicsTestRunner.getenv("WAIFUPICS_TEST_OVERRIDE")
        ...
        explain = WaifuPicsTestRunner.getenv("WAIFUPICS_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["WAIFUPICS_TEST_EXPLAIN"] = explain
