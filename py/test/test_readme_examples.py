# WaifuPics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WaifuPicsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WaifuPicsSDK(...) and WaifuPicsSDK.test(...) become
#      WaifuPicsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "waifupics_sdk"
_SDK_CLASS = "WaifuPicsSDK"
