...
class ImageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ImageEntity(self._client, opts)
    ...
    def list(self, reqmatch: ImageListMatch, ctrl=None) -> list[Image]:
