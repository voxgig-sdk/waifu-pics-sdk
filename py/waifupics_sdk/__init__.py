...
from waifupics_sdk.utility import register

# Load features
from waifupics_sdk.feature.base_feature import WaifuPicsBaseFeature
from waifupics_sdk.features import _has_feature, _make_feature
...
class WaifuPicsSDK:
    ...
    def get_utility(self):
        return WaifuPicsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WaifuPicsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Image(self, data=None) -> "ImageEntity":
        ...
        from waifupics_sdk.entity.image_entity import ImageEntity
