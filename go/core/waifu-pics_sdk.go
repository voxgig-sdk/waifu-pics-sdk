...
func (sdk *WaifuPicsSDK) OptionsMap() map[string]any {
...
func (sdk *WaifuPicsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *WaifuPicsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *WaifuPicsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaifuPicsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *WaifuPicsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *WaifuPicsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("WaifuPicsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *WaifuPicsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *WaifuPicsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("WaifuPicsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
