...
func NewImageEntity(client *core.WaifuPicsSDK, entopts map[string]any) *ImageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ImageEntity) GetName() string { return e.name }
...
func (e *ImageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ImageEntity) Deleted() bool {
	return e.deleted
}


func (e *ImageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewImageEntity(e.client, opts)
}

func (e *ImageEntity) Data(args ...any) any {
...
func (e *ImageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Image; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ImageEntity) DataTyped(data ...Image) Image {
	if len(data) > 0 {
		return typedFrom[Image](e.Data(asMap(data[0])))
	}
	return typedFrom[Image](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Image (all fields
// optional at the wire level).
func (e *ImageEntity) MatchTyped(match ...Image) Image {
	if len(match) > 0 {
		return typedFrom[Image](e.Match(asMap(match[0])))
	}
	return typedFrom[Image](e.Match())
}
...
func (e *ImageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ImageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ImageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ImageListMatch and returns []Image. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ImageEntity) ListTyped(reqmatch ImageListMatch, ctrl map[string]any) ([]Image, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Image](res), nil
}



func (e *ImageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ImageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ImageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ImageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
