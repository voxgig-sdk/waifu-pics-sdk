...
|---|---|---|
| `ts/` | @voxgig-sdk/waifu-pics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/waifu-pics-sdk \
      --repository voxgig-sdk/waifu-pics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/waifu-pics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/waifu-pics-sdk --id=<id>` removes it.
