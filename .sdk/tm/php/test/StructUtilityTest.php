...
// WaifuPics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WaifuPicsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WaifuPicsOmni::structfix($now, Struct::undef()))
                        !== json_encode(WaifuPicsOmni::structfix($val, Struct::undef()))) {
