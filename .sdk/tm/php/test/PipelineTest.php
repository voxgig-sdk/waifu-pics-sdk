...
{
    private static function utility(): WaifuPicsUtility
    {
        return new WaifuPicsUtility();
    }
    ...
    private static function ctx(array $over = []): WaifuPicsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new WaifuPicsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new WaifuPicsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof WaifuPicsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new WaifuPicsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = WaifuPicsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new WaifuPicsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = WaifuPicsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new WaifuPicsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = WaifuPicsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaifuPicsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = WaifuPicsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new WaifuPicsResponse([]),
            'result' => new WaifuPicsResult([]),
        ]);
        [, $err] = WaifuPicsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec([]),
            'response' => null,
            'result' => new WaifuPicsResult([]),
        ]);
        [, $err] = WaifuPicsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec(['step' => 's']),
            'response' => new WaifuPicsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new WaifuPicsResult([]),
        ]);
        [, $err] = WaifuPicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec(['step' => 's']),
            'response' => new WaifuPicsResponse(self::resp(200, ['v' => 1])),
            'result' => new WaifuPicsResult([]),
        ]);
        [, $err] = WaifuPicsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec(['step' => 's']),
            'response' => new WaifuPicsResponse(self::resp(200, ['v' => 2])),
            'result' => new WaifuPicsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        WaifuPicsMakeResponse::call($ctx);
    ...
    {
        $preset = new WaifuPicsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec([]),
            'response' => new WaifuPicsResponse([]),
            'result' => new WaifuPicsResult([]),
        ...
        [$got, $err] = WaifuPicsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new WaifuPicsResult([])]);
        [, $err] = WaifuPicsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new WaifuPicsSpec([]), 'result' => null]);
        [, $err] = WaifuPicsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaifuPicsSpec(['step' => 's']),
            'result' => new WaifuPicsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new WaifuPicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaifuPicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new WaifuPicsSpec(['step' => 's']),
            'result' => new WaifuPicsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new WaifuPicsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = WaifuPicsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new WaifuPicsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new WaifuPicsSpec([]),
            'result' => new WaifuPicsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = WaifuPicsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaifuPicsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new WaifuPicsError('boom', 'boom');
        $utility->fetcher = function (WaifuPicsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaifuPicsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = WaifuPicsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (WaifuPicsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = WaifuPicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(WaifuPicsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (WaifuPicsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new WaifuPicsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = WaifuPicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new WaifuPicsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new WaifuPicsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = WaifuPicsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = WaifuPicsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = WaifuPicsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new WaifuPicsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, WaifuPicsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new WaifuPicsResult(['ok' => false])]);
        $this->expectException(WaifuPicsError::class);
        WaifuPicsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new WaifuPicsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', WaifuPicsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        WaifuPicsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new WaifuPicsBaseFeature();
        $b = new WaifuPicsBaseFeature();
        WaifuPicsFeatureAdd::call($ctx, $a);
        WaifuPicsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): WaifuPicsBaseFeature
    {
        $f = new WaifuPicsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        WaifuPicsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): WaifuPicsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new WaifuPicsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = WaifuPicsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new WaifuPicsResponse(['headers' => null]),
            'result' => new WaifuPicsResult([]),
        ]);
        WaifuPicsResultHeaders::call($ctx);
