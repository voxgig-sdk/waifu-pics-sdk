...
class WaifuPicsTimeoutFeature extends WaifuPicsBaseFeature
{
    ...
    private function _with_timeout(WaifuPicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WaifuPicsContext $_ctx, float $ms): void
    {
        $client = $this->client;
