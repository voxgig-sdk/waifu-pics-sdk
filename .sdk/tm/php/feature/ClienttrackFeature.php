...
// WaifuPics SDK clienttrack feature
...
class WaifuPicsClienttrackFeature extends WaifuPicsBaseFeature
{
    ...
    public function PostConstruct(WaifuPicsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WaifuPics-SDK';
