...
class WaifuPicsProxyFeature extends WaifuPicsBaseFeature
{
    ...
    public function init(WaifuPicsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WaifuPicsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
