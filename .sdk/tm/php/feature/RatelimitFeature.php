...
// WaifuPics SDK ratelimit feature
...
class WaifuPicsRatelimitFeature extends WaifuPicsBaseFeature
{
    ...
    private function _acquire(WaifuPicsContext $ctx): void
    {
    ...
    private function _track(WaifuPicsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
