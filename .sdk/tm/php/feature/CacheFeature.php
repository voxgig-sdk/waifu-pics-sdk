...
class WaifuPicsCacheFeature extends WaifuPicsBaseFeature
{
    ...
    private function _through(WaifuPicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
