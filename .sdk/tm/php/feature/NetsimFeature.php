...
class WaifuPicsNetsimFeature extends WaifuPicsBaseFeature
{
    ...
    private function _simulate(WaifuPicsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WaifuPicsContext $ctx, array $applied): void
    {
        $client = $this->client;
