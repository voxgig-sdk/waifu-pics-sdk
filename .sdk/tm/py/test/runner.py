...
class WaifuPicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaifuPicsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WaifuPicsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WaifuPicsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
