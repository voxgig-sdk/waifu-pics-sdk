...
class WaifuPicsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WaifuPicsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = WaifuPicsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = WaifuPicsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
