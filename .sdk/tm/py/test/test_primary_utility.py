...
from projectname_sdk import WaifuPicsSDK
from projectname_sdk.core.spec import WaifuPicsSpec
from projectname_sdk.core.result import WaifuPicsResult
from projectname_sdk.core.response import WaifuPicsResponse
from projectname_sdk.core.operation import WaifuPicsOperation
from projectname_sdk.core.error import WaifuPicsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import WaifuPicsBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return WaifuPicsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = WaifuPicsSDK.test(None, None)
        ...
        class TestInitFeature(WaifuPicsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WaifuPicsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WaifuPicsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WaifuPicsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WaifuPicsSDK.test(None, setup_opts)
