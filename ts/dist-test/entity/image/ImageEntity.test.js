...
(0, node_test_1.describe)('ImageEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.WaifuPicsSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.WaifuPicsSDK.test(options, extra);
    const struct = client.utility().struct;
    const merge = struct.merge;
    const transform = struct.transform;
    let idmap = transform(['image01', 'image02', 'image03', 'many01', 'many02', 'many03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    if (live) {
        ...
        client = new __1.WaifuPicsSDK(merge([
