...
function envOverride(m) {
    if ('TRUE' === process.env.WAIFU_PICS_TEST_LIVE ||
        'TRUE' === process.env.WAIFU_PICS_TEST_OVERRIDE) {
    ...
    m.WAIFU_PICS_TEST_EXPLAIN = process.env.WAIFU_PICS_TEST_EXPLAIN || m.WAIFU_PICS_TEST_EXPLAIN;
    return m;
}
