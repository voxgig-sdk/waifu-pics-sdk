...
// WaifuPics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WaifuPicsSDK::test)
...
{
    private const SDK_CLASS = 'WaifuPicsSDK';
    ...
    private const SDK_BASE = 'waifupics_sdk';
