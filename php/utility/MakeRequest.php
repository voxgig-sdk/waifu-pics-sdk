...
// WaifuPics SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WaifuPicsMakeRequest
{
    public static function call(WaifuPicsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WaifuPicsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WaifuPicsResponse($fetched);
        } else {
