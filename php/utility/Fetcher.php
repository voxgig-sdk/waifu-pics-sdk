...
// WaifuPics SDK utility: fetcher

class WaifuPicsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WaifuPicsSDK/1.0)';
    ...
    public static function call(WaifuPicsContext $ctx, string $fullurl, array $fetchdef): array
    {
