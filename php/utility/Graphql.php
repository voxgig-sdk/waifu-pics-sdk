...
class WaifuPicsGraphql
{
    ...
    // equivalent.
    public static function body(WaifuPicsContext $ctx): mixed
    {
    ...
    public static function errors(WaifuPicsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
