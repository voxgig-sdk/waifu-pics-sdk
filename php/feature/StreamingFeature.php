...
// WaifuPics SDK streaming feature
...
class WaifuPicsStreamingFeature extends WaifuPicsBaseFeature
{
    ...
    private function _iterate(WaifuPicsResult $result): \Generator
    {
    ...
    private function _streamable(WaifuPicsContext $ctx): bool
    {
