...
class WaifuPicsRbacFeature extends WaifuPicsBaseFeature
{
    ...
    private function _required(WaifuPicsContext $ctx): ?string
    {
    ...
    private function _reject(WaifuPicsContext $ctx, string $required): void
    {
    ...
    private function _track(WaifuPicsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
