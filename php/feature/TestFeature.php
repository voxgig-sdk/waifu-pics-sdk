...
// WaifuPics SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WaifuPicsTestFeature extends WaifuPicsBaseFeature
{
    ...
    public function init(WaifuPicsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WaifuPicsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = WaifuPicsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WaifuPicsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WaifuPicsContext $ctx, $op, $args): array
    {
