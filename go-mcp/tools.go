...
type Args struct {
	Entity string         `json:"entity" jsonschema:"image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WaifuPicsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "waifu-pics_list",
		Description: "List records from WaifuPics. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "waifu-pics_load",
		Description: "Load a single record from WaifuPics. " +
...
func runOp(client *sdk.WaifuPicsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WaifuPicsSDK, name string) (sdk.WaifuPicsEntity, error) {
